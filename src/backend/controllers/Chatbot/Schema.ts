...
export const ChatbotSchema = t.Union([
	t.Object({
		...
		images: t.Optional(t.Array(t.String({
			title: "URL da imagem",
			examples: ["https://example.com/image.png", "https://example.com/image.jpg"],
		...
		examples: [
			{
				...
				images: ["https://example.com/image.png", "https://example.com/image.jpg"],
			},
		],
	...
	t.Object({
		audio: t.Optional(t.String({
			title: "URL do áudio",
			examples: ["https://example.com/audio.mp3", "https://example.com/audio.wav"],
